...
public class LtcBudgetCompBenefits implements IModel {
	...
	/**
	 * CHEFS computes this field client-side as benefitsAmountBudget / benefitsValueTotal * 100.
	...
	public void determineBenefitsPercentageAlloc(String benefitsValueTotal) {
		if (CSVUtil.isInvalidDecimal(this.benefitsPercentageAlloc)) {
			this.benefitsPercentageAlloc = CSVUtil.calculatePercentageOfTotal(this.benefitsAmountBudget, benefitsValueTotal);
		}
	}
	@Override
