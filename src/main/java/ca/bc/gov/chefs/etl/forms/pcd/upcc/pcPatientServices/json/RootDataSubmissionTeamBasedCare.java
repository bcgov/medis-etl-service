...
public class RootDataSubmissionTeamBasedCare {
  ...
  public String toString() {
    return "RootDataSubmissionTeamBasedCare [deliveredVirtuallyPrac=" + deliveredVirtuallyPrac
        + ", totalPatientEncounters=" + totalPatientEncounters + ", duringBusinessHoursPrac=" + duringBusinessHoursPrac
        ...
        + patientEncountersPracSubtotals + ", patientEncountersNonPracSubtotals=" + patientEncountersNonPracSubtotals
        + "]";
  }
