...
public class FRPcnFinancialTotals implements IModel {
    ...
    private BigDecimal ftesInclRelief = BigDecimal.ZERO;
    ...
    public BigDecimal getFtesInclRelief() {
        return ftesInclRelief;
    }

    public void setFtesInclRelief(BigDecimal ftesInclRelief) {
    ...
    public List<String> getCsvElements() {
        ...
        elements.add(formatBigDecimal(annualBudget));
        ...
        elements.add(formatBigDecimal(ftesInclRelief));
