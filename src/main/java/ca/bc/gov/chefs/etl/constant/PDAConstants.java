    ...
    static {
        ...
        HEADERS.put(PDA_WAIT_TIME_SUBMISSION,
                new String[] { "SUBMISSION_ID", "CREATED_AT", "LATE_ENTRY", "SUBMITTER_FULL_NAME",
                        "SUBMITTER_USER_NAME", "SUBMITTER_EMAIL", "SUBMISSION_STATUS", "SUBMISSION_VERSION",
                        "SUBMISSION_FORM_NAME", "PERIOD", "FACILITY", "FACILITY_ID", "FISCAL_YEAR" });
        HEADERS.put(PDA_WAIT_TIME_DATA,
                new String[] { "SUBMISSION_ID", "PDA_WAIT_TIME_DATA_ID", "FACILITY_ID", "HEALTH_AUTHORITY", "REGION",
                        "PRIORITY", "PATIENT_REF", "SLEEP_ISSUE", "REFERRAL_DATE", "LEVEL_1_STUDY_DATE",
                        "SPECIALIST_CONSULT_DATE", "CONSULT_TO_STUDY_WAIT_TIME", "REFERRAL_TO_CONSULT_WAIT_TIME",
