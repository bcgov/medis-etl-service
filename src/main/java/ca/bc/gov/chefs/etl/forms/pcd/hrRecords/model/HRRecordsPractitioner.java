...
public class HRRecordsPractitioner implements IModel {
    ...
    public String getOtherPaymentModality() {
        return CSVUtil.replaceCarriageReturnLineFeed(otherPaymentModality);
    }
    ...
    public List<String> getCsvElements() {
        ...
        elements.add(getOtherPaymentModality());
    ...
    public String toString() {
        return "HRRecordsPractitioner [submissionId=" + submissionId + ", hrRecordId=" + hrRecordId
                + ", practitionerType=" + practitionerType + ", practitionerName=" + practitionerName
                + ", practitionerFirstName=" + practitionerFirstName + ", practitionerLastName=" + practitionerLastName
                + ", practitionerRole=" + practitionerRole + ", practitionerBillingNumber=" + practitionerBillingNumber
                ...
                + fteEquivalent + ", paymentModality=" + paymentModality + ", otherPaymentModality="
                + otherPaymentModality + ", dateHired=" + dateHired + ", fiscalYear=" + fiscalYear + ", period="
                + period + ", employmentStatus=" + employmentStatus + ", dateEmploymentStatusChanged="
                + dateEmploymentStatusChanged + ", recordCreationDate=" + recordCreationDate + ", notes=" + notes
                + ", legacyWebformId=" + legacyWebformId + "]";
    }
