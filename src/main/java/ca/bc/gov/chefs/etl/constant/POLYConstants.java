...
public class POLYConstants extends Constants {
    ...
    public static final String POLY_WAIT_TIME_UNENCRYPTED_FP = FileUtil.buildDestinationPath(PROPERTIES_POLY_WAIT_TIME, false);
    public static final String POLY_WAIT_TIME_ENCRYPTED_FP = FileUtil.buildDestinationPath(PROPERTIES_POLY_WAIT_TIME, true);
    ...
    static {
        ...
        /** Wait Time Report Form */
        HEADERS.put(POLY_WAIT_TIME_SUBMISSION, new String[] {"SUBMISSION_ID", "CREATED_AT", "LATE_ENTRY", "SUBMITTER_FULL_NAME", "SUBMITTER_USER_NAME", "SUBMITTER_EMAIL", "SUBMISSION_STATUS",
                "SUBMISSION_VERSION", "SUBMISSION_FORM_NAME", "PERIOD", "FACILITY", "FISCAL_YEAR"});
        HEADERS.put(POLY_WAIT_TIME_DATA, new String[] {"SUBMISSION_ID", "POLY_WAIT_TIME_DATA_ID", "FACILITY", "HEALTH_AUTHORITY", "REGION", "PRIORITY", "PATIENT_REF", "SLEEP_ISSUE", "REFERRAL_DATE",
                "LEVEL_1_STUDY_DATE", "SPECIALIST_CONSULT_DATE", "CONSULT_TO_STUDY_WAIT_TIME", "REFERRAL_TO_CONSULT_WAIT_TIME", "TOTAL_WAIT_TIME", "SELECT_COMMENT", "OTHER_COMMENT"});
        HEADERS.put(POLY_WAIT_TIME_DATA_MANUAL, new String[] {"FISCAL_YEAR", "PERIOD", "FACILITY_ID", "ORIGIN", "REFERRAL_DATE", "CONSULT_DATE", "ISSUE", "PRIORITY", "STUDY_DATE",
                "REFERRAL_TO_CONSULT_WAIT_TIME", "CONSULT_TO_STUDY_WAIT_TIME", "TOTAL_WAIT_TIME", "PATIENT_REF", "CONFIRMATION_ID"});
