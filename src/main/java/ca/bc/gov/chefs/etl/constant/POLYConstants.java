...
public class POLYConstants extends Constants {
        ...
        static {
                ...
                HEADERS.put(POLY_WAIT_TIME_DATA,
                                new String[] {"SUBMISSION_ID", "POLY_WAIT_TIME_DATA_ID", "FACILITY", "HEALTH_AUTHORITY", "REGION", "PRIORITY", "PATIENT_REF", "SLEEP_ISSUE", "REFERRAL_DATE",
                                                "LEVEL_1_STUDY_DATE", "SPECIALIST_CONSULT_DATE", "CONSULT_TO_STUDY_WAIT_TIME", "REFERRAL_TO_CONSULT_WAIT_TIME", "TOTAL_WAIT_TIME", "SELECT_COMMENT",
                                                "OTHER_COMMENT"});
