...
public class RootTotals {
    ...
    public String overheadDofpAllocation;
    public String dofpResourcesAllocation;
    public String physicianApprovedBudget;
    public String physicianFiscalYearFtes;
    public String clinicalBudgetAllocation;
    public String overheadBudgetAllocation;
    public String dofpResourcesApprovedFtes;
    public String physicianBudgetAllocation;
    public String overheadDofpApprovedBudget;
    public String dofpResourcesApprovedBudget; 
    public String dofpResourcesFiscalYearFtes;
    public String healthAuthorityApprovedFtes; 
    public String oneTimeFundingDofpAllocation;
    public String healthAuthorityApprovedBudget;
    public String healthAuthorityFiscalYearFtes;
    ...
    public String getOverheadDofpAllocation() {
        return overheadDofpAllocation;
    }
    public void setOverheadDofpAllocation(String overheadDofpAllocation) {
        this.overheadDofpAllocation = overheadDofpAllocation;
    }
