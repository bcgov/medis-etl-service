...
public class PCDConstants extends Constants {
	...
	public final static String FINANCIAL_EXPENSE_ITEM_SUB_CATEGORY = "FINANCIAL_EXPENSE_ITEM_SUB_CATEGORY";
	...
	static {
		...
		HEADERS.put(FINANCIAL_EXPENSE_CATEGORY, new String[] {
			"SUBMISSION_ID", "EXPENSE_CATEGORY_ID", "INITIATIVE_TYPE", "TYPE_OF_CARE",
			"EXPENSE_CATEGORY"
        });
		...
		HEADERS.put(FINANCIAL_EXPENSE_ITEM, new String[] {
			...
			"RESOURCE_CATEGORY", "POSITION_TYPE"
        });
		HEADERS.put(FINANCIAL_EXPENSE_ITEM_SUB_CATEGORY, new String[] {
