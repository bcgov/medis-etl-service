...
public class PCDConstants extends Constants {
	...
	static {
		...
		HEADERS.put(HA_HIERARCHY_COMMUNITY, new String[] {
				"SUBMISSION_ID", "COMMUNITY_ID", "COMMUNITY_NAME", "HSIAR_SERVICE_PLAN_GAP_ANALYSIS", "HSIAR_SERV_PL_GAP_ANLYS_DATE"
		});
		...
		HEADERS.put(PROVINCIAL_RISK_TRACKING, new String[] {
			"SUBMISSION_ID","CREATED_AT","LATE_ENTRY","SUBMITTER_FULL_NAME","SUBMITTER_USER_NAME","SUBMITTER_EMAIL","SUBMISSION_STATUS","SUBMISSION_VERSION","SUBMISSION_FORM_NAME","TYPE_OF_INITIATIVE","ISSUE_RAISED_DATE","RELEVANT_SITES","ISSUE_CLOSED_DATE","ISSUE_AND_RISK_DESCRIPTION","DATE_MITIGATION_PLAN_COMMS","MITIGATION_STRATEGY","ISSUES_NOTES","LEVEL_OF_RISK","ISSUE_AND_RISK_TITLE"	});
