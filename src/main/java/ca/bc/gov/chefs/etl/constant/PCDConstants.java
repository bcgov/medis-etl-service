...
public class PCDConstants extends Constants {
	...
	public static final String PCD_DECISION_LOG_ENCRYPTED_FP = FileUtil.buildDestinationPath(PROPERTIES_PCD_DECISION_LOG,
			true);
	...
	public static final String PCD_UPCC_BUDGET_UNENCRYPTED_FP = FileUtil.buildDestinationPath(PROPERTIES_PCD_UPCC_BUDGET,
			false);
	...
	static {
		...
		HEADERS.put(PCD_STATUS_TRACKER_SUBMISSION, new String[] {
				...
				"EOI_SUBMISSION_DATE", "EOI_APPROVAL_DATE", "SP_SUBMISSION_DATE", "SP_APPROVAL_DATE", "IMPLEMENTATION_DATE",
		...
		HEADERS.put(PC_PATIENT_SERVICES_UPCC_SUBMISSION, new String[] {
				...
				"HEALTH_AUTHORITY", "UPCC_TYPE_OF_CARE", "FISCAL_YEAR", "PERIOD_REPORTED", "REASON_FOR_EXCEPT_PERIOD_REP",
				"NOTES"
		});
